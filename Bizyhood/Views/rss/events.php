...
<channel>
        ...
        <?php
          ...
          $data_page_id    = Bizyhood_Utility::getOption(Bizyhood_Core::KEY_EVENTS_PAGE_ID);
          ...
          ?>
            <item>
              ...
              <description><![CDATA[<?php echo strip_tags($entry['description']); ?>]]></description>
              <content:encoded><![CDATA[<?php echo $entry['description']; ?>]]></content:encoded>
              <?php rss_enclosure(); ?>
