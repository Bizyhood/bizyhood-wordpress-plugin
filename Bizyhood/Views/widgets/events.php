...
class bizy_events_widget extends WP_Widget {
  ...
  ';
	...
	public function form( $instance ) {
		...
		$color_event_font = ! empty( $instance['color_event_font'] ) ? $instance['color_event_font'] : self::$default_colors['color_event_font'];
    ...
    <div class="color_wrap" id="color_wrap_<?php echo $uid; ?>">
      ...
      <p>
        ...
        <input data-default-color="<?php echo self::$default_colors['color_event_font']; ?>" class="widefat color-picker colorfield colorfield_<?php echo $uid; ?> " id="<?php echo $this->get_field_id( 'color_event_font' ); ?>" name="<?php echo $this->get_field_name( 'color_event_font' ); ?>" type="text" value="<?php echo esc_attr( $color_event_font ); ?>">
      </p>
      <p>
