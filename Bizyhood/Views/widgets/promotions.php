...
class bizy_promotions_widget extends WP_Widget {
  ...
  ';
	...
	public function form( $instance ) {
		...
		$color_promotion_font = ! empty( $instance['color_promotion_font'] ) ? $instance['color_promotion_font'] : self::$default_colors['color_promotion_font'];
    ...
    <div class="color_wrap" id="color_wrap_<?php echo $uid; ?>">
      ...
      <p>
        ...
        <input data-default-color="<?php echo self::$default_colors['color_promotion_font']; ?>" class="widefat color-picker colorfield colorfield_<?php echo $uid; ?> " id="<?php echo $this->get_field_id( 'color_promotion_font' ); ?>" name="<?php echo $this->get_field_name( 'color_promotion_font' ); ?>" type="text" value="<?php echo esc_attr( $color_promotion_font ); ?>">
      </p>
      <p>
